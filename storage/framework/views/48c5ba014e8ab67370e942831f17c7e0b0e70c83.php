            ...
            <div class=" section-content">
                <div class="row">
                    <div class="col-md-5 col-sm-6">
                        <form class="reservation-form" method="post" action="<?php echo e(route('reservation.reserve')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                <div class="row">
                    <form class="contact-form" method="post" action="<?php echo e(route('contact.send')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        &copy; Copyright, 2018 <a href="#">Mamma's Kitchen.</a> Developed by <a href="https://github.com/nisalman">Md.Noor Islam Salman</a>
                    </p>
                </div>
            </div>
        </div>
